...
class Celula {
    ...
    protected Series elemento; // Conteudo da celula
    protected Celula prox; // Aponta a celula prox.
...
class Lista {
    ...
    /**
     * Metodo publico iterativo que insere os objetos no inicio da lista
     *
     * @param serie Objeto a ser inserido
     */
    ...
    /**
     * Metodo publico iterativo que insere os objetos no fim da lista
     *
     * @param serie Objeto a ser inserido
     */
     ...
     * caso contrario.
     */
    public boolean pesquisarLista(String x) {
    ...
    /**
     * Metodo publico iterativo que mostra os o conteudo da lista
     */
    ...
    /**
     * Metodo publico iterativo que pega o tamanho da lista
     *
...
class Hash {
    ...
    /**
     * Metodo publico Iterativo que calcula a pos em que a serie vai ser
     * inserida
     *
     * @param elemento Elemento a ser inserido
     * @return pos em que o elemento vai ser isnerido
     */
    ...
    /**
     * Metodo publico iterativo que verifica se a serie esta presente na hash
     *
     * @param elemento Nome da serie a ser analisada
     * @return pos em que o elemento esta inserido, return -1 se o elemento nao
     * estiver la
     */
    public int pesquisar(String elemento) {
        int pos = h(pegarValor(elemento));
        int k = -1;
        if (tabela[pos].pesquisarLista(elemento)) {
            k = pos;
        }
        return k;
    }
    ...
    /**
     * Metodo publico iterativo que insere um objeto no inicio da lista
     *
     * @param elemento Serie a ser inserida
     */
    ...
    /**
     * Metodo publico iterativo que mostra os elementos da hash
     */
    public void mostrar() {
        for (int i = 0; i < tamanho; i++) {
            if (tabela[i] != null) {
                tabela[i].mostrarLista();
            }
        }
    }
...
public class TP07Q07 {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        Arq.openWrite("576473_hashIndireta.txt", "UTF-8");
