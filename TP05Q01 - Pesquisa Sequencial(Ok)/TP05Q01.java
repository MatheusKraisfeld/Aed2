...
class Lista{
   ...
   //verifica se o elemento esta contido na lista e retorna true ou false ;
   public boolean possuiElemento(String entrada){
      boolean resp  = false;
      String b = "";
      for (int i = 0 ; i < cont ; i++) {
         b = array[i].getNome();
...
class TP05Q01 {
   public static void main(String[] args)throws Exception {
	...
	in = MyIO.readLine();
      ...
      Arq.openWrite("576473_sequencial.txt", "UTF-8");
