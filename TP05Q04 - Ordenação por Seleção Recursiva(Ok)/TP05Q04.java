   ...
   public void selecao(int i){
      if(i<cont-1){
         ...
         for (int j = (i + 1); j < cont; j++){
           ...
           if(stringIgual(array[menor].getPaisOrigem() , array[j].getPaisOrigem())){
           ...
           else if (compararString(array[menor].getPaisOrigem() , array[j].getPaisOrigem())){
               menor = j;
            }
...
class TP05Q04{
   public static void main(String[] args)throws Exception{
      ...
      Arq.openWrite("576473_selecaoRecursivo.txt", "UTF-8");
